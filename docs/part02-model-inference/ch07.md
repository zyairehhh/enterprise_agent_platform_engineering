...
> **估计阅读**：L1 20 min / L1+工程 45 min / 全章 90 min
...
第 6 节讨论的是“选哪个推理引擎、如何理解吞吐与延迟的取舍”。本节进一步进入推理优化机制本身。企业平台团队真正关心的问题通常不是某个优化名词是否先进，而是它能否稳定降低成本、延迟或显存占用，同时不破坏模型质量和业务正确性。
...
### 7.2 Prefix Cache 对多轮对话与共享前缀场景的加速
...
### 7.3 Speculative Decoding：以小模型辅助大模型的无损解码加速
