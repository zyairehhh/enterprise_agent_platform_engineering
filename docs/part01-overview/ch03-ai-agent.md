...
| 需求目标 | 增加某功能 | 完成某类任务 |
| 用户路径 | 页面跳转流程 | 任务状态流转 |
| 输入输出 | 字段和表单 | 目标、约束、上下文、交付物 |
| 异常处理 | 表单校验和错误提示 | 不确定性、追问、接管、降级 |
| 验收标准 | 功能是否可用 | 任务质量、证据、风险控制 |

这就是为什么第三章要放在平台总论里。AI 原生改变的不只是技术，也改变了产品团队描述问题的方式。

**AI 原生对管理层意味着什么。**

对管理层来说，AI 原生最重要的不是“用了多少 AI”，而是企业是否开始形成新的运营能力。
