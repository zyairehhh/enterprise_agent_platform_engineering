...
当线上问题被确认后，它要回到离线资产。一次错误回答应沉淀为 query、上下文包、期望答案、错误类型和修复说明；一次评估误判应沉淀为裁判失败样本；一次人工复核争议应更新 rubric。持续优化不是不断调 prompt，而是把生产失败转化成可重复验证的资产。
...
在这个意义上，Judge 不是裁判席上的唯一声音，而是质量团队的放大镜。它帮助团队更快看到问题，但最终仍要回到证据、专家判断和发布后反馈。
