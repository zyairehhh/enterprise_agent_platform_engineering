...
长期维护的 leaderboard 可参考 [Spider](https://yale-lily.github.io/spider)、[BIRD](https://bird-bench.github.io/)、[BEAVER](https://beaverbench.github.io/)、[HELM](https://crfm.stanford.edu/helm/)、[MTEB](https://huggingface.co/spaces/mteb/leaderboard) 与 [SWE-bench](https://www.swebench.com/)。评测工具可参考 Ragas、TruLens、DeepEval、Promptfoo、OpenTelemetry、Langfuse 和 Phoenix。
