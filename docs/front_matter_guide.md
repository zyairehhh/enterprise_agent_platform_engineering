...
本页先说明全书主线，再给出按角色和按问题类型的阅读路径，最后说明中文第一版的版本边界。读者进入正文前可以先建立方向感，后续也可以把章节、图表、附录和检查清单组合成工作参考。
...
Part XI 当前定位为案例方法论和后续案例准入规则。正式业务案例需要真实材料、脱敏过程和作者确认，第一版暂不把未验证素材写成案例正文。
...
中文第一版优先处理三类稳定内容：已经成章的技术主线、可验证的图表和代码引用、可本地构建的网页电子书工程。当前版本不预填真实客户案例、贡献者致谢或未实现项目能力。
